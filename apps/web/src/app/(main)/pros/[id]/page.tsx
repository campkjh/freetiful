...
const MOCK_PRO = {
  ...
  rating: 0,
  reviewCount: 0,
  plans: [] as { id: string; label: string; price: number; duration: string; title: string; desc: string[]; workDays: number; revisions: number }[],
  description: '',
  expertStats: {
    totalDeals: 0,
    satisfaction: 0,
  ...
  otherServices: [] as { id: string; title: string; price: number; rating: number; reviewCount: number; image: string }[],
  reviews: [] as any[],
  recommendedPros: [] as any[],
  alsoViewed: [] as any[],
};
