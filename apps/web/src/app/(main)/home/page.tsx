...
const MOCK_PROS = [
  { id: '1', name: '박인애', category: 'MC', role: '사회자', region: '전국', rating: 5.0, reviews: 15, pudding: 1, image: 'https://i.pravatar.cc/300?img=1', images: ['https://i.pravatar.cc/300?img=1', 'https://i.pravatar.cc/200?img=14', 'https://i.pravatar.cc/200?img=15'], intro: '우아하고 위트있는 진행의 정석', price: 500000, experience: 13, tags: ['전국가능', '우아한', '위트있는'], available: true, youtubeId: 'dQw4w9WgXcQ' },
  { id: '2', name: '김서현', category: 'MC', role: '사회자', region: '서울/경기', rating: 4.9, reviews: 142, pudding: 2, image: 'https://i.pravatar.cc/300?img=5', images: ['https://i.pravatar.cc/300?img=5', 'https://i.pravatar.cc/200?img=16', 'https://i.pravatar.cc/200?img=17'], intro: '감동과 웃음을 동시에 선사하는 웨딩 전문 MC', price: 550000, experience: 15, tags: ['서울/경기', '감동적인', '유머러스한'], available: true, youtubeId: 'jNQXAC9IVRw' },
  { id: '3', name: '이하늘', category: 'MC', role: '사회자', region: '서울/경기', rating: 4.8, reviews: 98, pudding: 3, image: 'https://i.pravatar.cc/300?img=9', images: ['https://i.pravatar.cc/300?img=9', 'https://i.pravatar.cc/200?img=18', 'https://i.pravatar.cc/200?img=19'], intro: '섬세한 진행력으로 당신의 하루를 완성합니다', price: 450000, experience: 8, tags: ['서울/경기', '섬세한', '전문적인'], available: true, youtubeId: 'kJQP7kiw5Fk' },
  { id: '4', name: '정다은', category: 'MC', role: '사회자', region: '서울/경기', rating: 5.0, reviews: 67, pudding: 4, image: 'https://i.pravatar.cc/300?img=10', images: ['https://i.pravatar.cc/300?img=10', 'https://i.pravatar.cc/200?img=20', 'https://i.pravatar.cc/200?img=21'], intro: '격식과 유쾌함의 완벽한 밸런스', price: 480000, experience: 10, tags: ['전국가능', '격식있는', '유쾌한'], available: true, youtubeId: 'L_jWHffIx5E' },
