...
const MOCK_SCHEDULES: ScheduleItem[] = [
  { id: '1', date: '2026-04-10', title: '결혼식 MC', category: 'MC', proName: '박인애', proImage: 'https://i.pravatar.cc/300?img=1', time: '14:00 - 16:00', location: '그랜드 웨딩홀', status: 'confirmed' },
  { id: '2', date: '2026-04-10', title: '축가 공연', category: '축가', proName: '채안빈', proImage: 'https://i.pravatar.cc/300?img=5', time: '14:30 - 15:00', location: '그랜드 웨딩홀', status: 'confirmed' },
  { id: '3', date: '2026-04-15', title: '웨딩 촬영', category: '스튜디오', proName: '로즈스튜디오', proImage: 'https://i.pravatar.cc/300?img=9', time: '10:00 - 13:00', location: '강남 스튜디오', status: 'pending' },
  { id: '4', date: '2026-04-18', title: '드레스 피팅', category: '드레스', proName: '라벨드레스', proImage: 'https://i.pravatar.cc/300?img=10', time: '15:00 - 17:00', location: '청담 쇼룸', status: 'pending' },
  { id: '5', date: '2026-04-22', title: '헤어 메이크업 리허설', category: '헤메샵', proName: '뷰티살롱', proImage: 'https://i.pravatar.cc/300?img=20', time: '11:00 - 13:00', location: '압구정 살롱', status: 'pending' },
  { id: '6', date: '2026-04-05', title: '웨딩홀 투어', category: '웨딩홀', proName: '더채플앳청담', proImage: 'https://i.pravatar.cc/300?img=12', time: '14:00 - 15:30', location: '청담동', status: 'completed' },
  { id: '7', date: '2026-04-03', title: 'MC 미팅', category: 'MC', proName: '김서현', proImage: 'https://i.pravatar.cc/300?img=15', time: '16:00 - 17:00', location: '카페', status: 'completed' },
  { id: '8', date: '2026-05-01', title: '본식 MC', category: 'MC', proName: '박인애', proImage: 'https://i.pravatar.cc/300?img=1', time: '12:00 - 14:00', location: '그랜드 웨딩홀', status: 'confirmed' },
  { id: '9', date: '2026-05-01', title: '본식 축가', category: '축가', proName: '채안빈', proImage: 'https://i.pravatar.cc/300?img=5', time: '12:30 - 13:00', location: '그랜드 웨딩홀', status: 'confirmed' },
];
