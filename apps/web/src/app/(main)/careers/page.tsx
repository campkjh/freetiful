        ...
        <div className="mx-auto max-w-[1000px] px-6">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-[11px] text-gray-300">{t({ ko: '프리티풀', en: 'Freetiful', ja: 'Freetiful', zh: 'Freetiful' })} | {t({ ko: '서울시 중구 퇴계로36길 2, 충무로관 본관 130호', en: 'Room 130, Chungmuro-gwan Main Building, 2 Toegye-ro 36-gil, Jung-gu, Seoul', ja: 'ソウル特別市中区退渓路36ギル2, 忠武路館本館130号', zh: '首尔市中区退溪路36街2号 忠武路馆本馆130号' })}</p>
